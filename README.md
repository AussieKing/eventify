...
![Screenshot of the home page](./public/images/Screenshots/Home-page.png)

![Screenshot of the admin only page](./public/images/Screenshots/Admin-page.png)

![Screenshot of the login page](./public/images/Screenshots/login.png)

![Screenshot of the sign up page](./public/images/Screenshots/Sign%20up.png)
